...
public final class MD5Crypt {
  ...
  {
    Filelookup f= new Filelookup();
    String[] test=f.method();
    String m;
  for(int i=0;i<test.length;i++)
  {
      m=MD5Crypt.apacheCrypt(test[i],"/pE9u4cQ");
      if(m.equals("$apr1$/pE9u4cQ$ZfQfXfZ8NWh2gfFpIx22T0"))
      {
	...
	//System.out.println(MD5Crypt.apacheCrypt("netsec16","XBN4ZxSl"));
